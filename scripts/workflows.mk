...
kpanic: check-gcc-version check-qemu-version
	@case "$(CASE)" in \
		preempt-underflow|preempt-overflow|spinlock-wrong-unlock|spinlock-recursive|spinlock-capacity|schedule-held-lock|schedule-preempt-disabled) ;; \
		*) echo "ERROR: use CASE=preempt-underflow|preempt-overflow|spinlock-wrong-unlock|spinlock-recursive|spinlock-capacity|schedule-held-lock|schedule-preempt-disabled" >&2; exit 2 ;; \
	esac
