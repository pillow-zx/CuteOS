...
__must_check
struct page_cache *page_cache_get(dev_t dev, uint64_t block, uint32_t flags, int *error);

__must_check
struct page_cache *page_cache_get_mapping(struct page_mapping *mapping, uint64_t index,
